      ...
      {platformAccounting ? (
        <section className="stats-grid">
          <article className="stat-card">
            ...
            <strong>{platformAccounting.invoices_total_amount}</strong>
          </article>
          <article className="stat-card">
            <span>Подтверждено</span>
            <strong>{platformAccounting.invoices_confirmed_amount}</strong>
          </article>
          <article className="stat-card">
            <span>Комиссия платформы</span>
            <strong>{platformAccounting.total_platform_revenue_amount}</strong>
          </article>
          <article className="stat-card">
            <span>Net amount</span>
            <strong>{platformAccounting.net_amount}</strong>
          </article>
        </section>
      ) : null}
