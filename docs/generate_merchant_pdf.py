...
SECTIONS: list[tuple[str, list[str]]] = [
    ...
    (
        "Комиссия платформы",
        [
            "Стандартный тариф: 0,4% от суммы успешного платежа, но не ниже 0,70 USD (эквивалент в USDT при settlement).",
            "Формула: комиссия = max(сумма × 0,004, 0,70 USD); нетто = сумма − комиссия.",
            "Примеры: $50 → $0,70 (минимум); $100 → $0,70; $175 → $0,70 (порог); $200 → $0,80; $500 → $2.",
            "Порог минимума: платежи до $175 включительно — комиссия $0,70.",
